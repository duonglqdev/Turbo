...
<main id="content" class="site-main">
    <div
        ...
        <div id="primary" class="w-full lg:w-3/4 site-main lg:pe-10">

            <?php
            for ($i = 0; $i < 4; $i++) {
                ?>
                <article id="post-2080"
                    class="mb-16 2xl:mb-20 post-2080 post type-post status-publish format-standard has-post-thumbnail hentry category-uncategorized">

                    <div class="entry-media flex items-start mb-4 md:mb-7">

                        <a class="post-thumbnail turbo-image-fade-in inline-flex items-start rounded-md overflow-hidden w-full"
                            href="https://turbo.redq.io/cruise-the-open-roads-hassle-free-car-hire/" aria-hidden="true"
                            tabindex="-1">
                            <noscript><img loading="lazy" width="1500" height="790"
                                    src="https://turbo.redq.io/wp-content/uploads/2023/05/1231.png"
                                    ...
                                    alt="" decoding="async"
                                    srcset="https://turbo.redq.io/wp-content/uploads/2023/05/1231.png 1500w, https://turbo.redq.io/wp-content/uploads/2023/05/1231-300x158.png 300w, https://turbo.redq.io/wp-content/uploads/2023/05/1231-1024x539.png 1024w, https://turbo.redq.io/wp-content/uploads/2023/05/1231-768x404.png 768w, https://turbo.redq.io/wp-content/uploads/2023/05/1231-600x316.png 600w"
                                    sizes="(max-width: 1500px) 100vw, 1500px" /></noscript><img loading="lazy" width="1500"
                                height="790"
                                src='data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%201500%20790%22%3E%3C/svg%3E'
                                data-src="https://turbo.redq.io/wp-content/uploads/2023/05/1231.png"
                                ...
                                data-sizes="(max-width: 1500px) 100vw, 1500px" /> </a>
                    </div>

                    <header class="">
                        <h2 class=" underlineEffectGroup mt-0 mb-3 sm:mb-[14px] md:mb-4 text-xl font-semibold">
                            <a class="no-underline underlineEffect break-words"
                                href="https://turbo.redq.io/cruise-the-open-roads-hassle-free-car-hire/"
                                rel="bookmark">Cruise the Open Roads: Hassle-Free Car Hire</a>
                        </h2>
                        <div class="entry-meta gap-y-3 flex flex-wrap items-center mb-6">
                            <span class="date flex items-center shrink-0 me-4 md:me-6 text-light-text">
                                ...
                                <span class="ms-2 inline-flex items-center text-sm">August 8, 2023</span>
                            </span>
                            <span
                                ...
                                <a class="category mr-2 text-sm no-underline text-light-text capitalize leading-6 md:leading-8"
                                    href="https://turbo.redq.io/category/uncategorized/">Uncategorized</a>
                            </span>
                        </div>
                    </header>

                    <div class="">
                        <p>In today&#8217;s digital landscape, where online competition is fierce, creating a
                            personalized and engaging website experience is paramount. Gone are the days of
                            one-size-fits-all approaches. Users now expect websites to cater to their specific needs,
                            interests, and preferences. By harnessing the power of personalization, you can deliver
                            targeted content, increase user engagement, and ultimately drive [&hellip;]</p>
                    </div>

                    <footer class="entry-footer mt-6 sm:mt-7">
                        <a class="turbo-outline-btn no-underline bg-brand !text-white text-sm leading-5 px-4 !py-3 !rounded-md uppercase"
                            href="https://turbo.redq.io/cruise-the-open-roads-hassle-free-car-hire/"> Read More </a>
                    </footer>
                </article>
                <?php
            }
            ...
            <nav class="pagination flex justify-between items-center border-t border-[#E7ECF0] pt-5">
                <div class="nav-previous"></div>
                <div class="nav-next">
                    <a href="https://turbo.redq.io/news/page/2/">Next
                        <span class="meta-nav inline-block">
                            <svg width="6" height="10" viewBox="0 0 6 10" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M5.85018 5.00003C5.85018 5.17925 5.78175 5.35845 5.64518 5.49508L1.34536 9.79486C1.07184 10.0684 0.628372 10.0684 0.354961 9.79486C0.0815496 9.52145 0.0815496 9.07807 0.354961 8.80452L4.15968 5.00003L0.355094 1.19551C0.0816825 0.921988 0.0816825 0.478652 0.355094 0.205262C0.628505 -0.0683918 1.07197 -0.0683918 1.34549 0.205262L5.64531 4.50497C5.78191 4.64168 5.85018 4.82087 5.85018 5.00003Z"
                                    fill="#8C969F" />
                            </svg>
                        </span>
                    </a>
