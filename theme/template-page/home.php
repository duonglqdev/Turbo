...
<main class="w-full">
    <div>
                    ...
                    <form class="flex flex-col gap-[30px] mt-[30px]" data-url="https://turbo.redq.io/car-listing/"
                        ...
                        <div class="">
                            ...
                            <div class="checkbox-group flex flex-col">
                                ...
                                <span class="box-border " dir="ltr" style="width: 319.325px">
                                    <span class="selection">
                                        <span class="select2-selection select2-selection--single" role="combobox"
                                            aria-haspopup="true" aria-expanded="false" tabindex="0"
                                            aria-labelledby="select2-tex_pickup_location-r9-container">
                                            <span class="select2-selection__rendered"
                                                id="select2-tex_pickup_location-r9-container">
                                            </span>
        ...
        <section class="pt-[160px] pb-[135px] w-full max-sm:pt-[60px] max-sm:pb-[50px]">
            <div>
                <div class="pb-[60px] flex flex-col justify-center items-center">
                ...
                <div class="flex px-2">
                    <div class="lg:container mx-auto px-4 layout-features">
                        <div
                            ...
                            <div
                                class="wf_card flex flex-wrap lg:flex-nowrap lg:items-center gap-2 3xl:gap-7 text-center sm:text-start max-sm:flex-col">
                                <figure
        ...
        <section class="bg-primary pt-[60px] pb-20 px-2 max-sm:pb-[50px] max-sm:pt-10">
            <div class="">
        ...
        <section class="pt-[100px] pb-[75px] max-sm:py-[60px]">
            <div class="flex flex-col justify-center items-center pb-[60px]">
                <h2 class="text-2xl font-bold uppercase text-center">Gặp gỡ những chiếc xe phổ biến</h2>
                <p class="text-light-text leading-7 text-center">
                    Giải pháp kinh doanh thích hợp cho doanh nghiệp đang phát triển của bạn
                </p>
            </div>
            <div class="grid grid-cols-4 gap-7 mx-10 px-4 max-sm:grid-cols-1 max-sm:mx-0">
                <?php
                for ($i = 0; $i < 9; $i++) {
                    ?>
                    <div
        ...
        <section class="px-2 pb-[170px] text-secondary h-fit max-sm:px-0 max-sm:pb-20">
            <div
